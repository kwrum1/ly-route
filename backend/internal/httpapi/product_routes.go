...
func productRoutes() []productRoute {
	return []productRoute{
		...
		{pattern: "/api/v1/dashboard/summary", capability: product.CapabilityDashboard, handler: bindHandler((*Server).handleDashboardSummary)},
		...
		{pattern: "/api/v1/telemetry/top-sessions", capability: product.CapabilityTelemetry, handler: telemetry("top_sessions")},
